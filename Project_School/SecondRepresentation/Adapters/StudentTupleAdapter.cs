...
public class StudentTupleAdapter : IStudent
{
    ...
    {
        get => _studentTuple.Fields.Where(f => f.Item1 == NamesString)
    ...
    {
        get =>
            _studentTuple.Fields.Where(f => f.Item1 == SurnameString)
    ...
    {
        get =>
            _studentTuple.Fields.Where(f => f.Item1 == SemesterString)
    ...
    {
        get => _studentTuple.Fields.Where(f => f.Item1 == ClassesString)
